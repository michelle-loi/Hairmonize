    ...
    return(
        <div>
            ...
            <div className="d-flex align-items-center mt-3 justify-content-start">
                ...
                <Link className="link" to={`/adminStylistHome/addEmployee`}>
                ...
                {employeeTable.map((employee)=>{
                    ...
                    return(
                        <tr key={employee.EID}>
                            ...
                            <td>
                                <Link className="link" to={`/adminStylistHome/editEmployee/${employee.EID}`}>
...
export default ViewEmployeesAS;